...
CREATE TABLE `account_book` (
  ...
  `user_mileage_seq` int unsigned NOT NULL COMMENT '유저 마일리지 시퀀스',
  ...
  `summary_text` varchar(100) NOT NULL,
  ...
  KEY `fk_account_book_user_mileage1_idx` (`user_mileage_seq`),
  CONSTRAINT `fk_account_book_user_mileage1` FOREIGN KEY (`user_mileage_seq`) REFERENCES `user_mileage` (`seq`)
...
CREATE TABLE `account_code_info` (
  ...
  `type2` char(1) NOT NULL COMMENT 'step2 a=완료, c=취소',
...
CREATE TABLE `accum_mile` (
  ...
  PRIMARY KEY (`seq`),
  KEY `fk_accum_mile_user_mileage1_idx` (`user_mileage_seq`),
  CONSTRAINT `fk_accum_mile_user_mileage1` FOREIGN KEY (`user_mileage_seq`) REFERENCES `user_mileage` (`seq`)
...
CREATE TABLE `accum_mile_log` (
  `seq` int unsigned NOT NULL AUTO_INCREMENT COMMENT '시퀀스',
  `accum_mile_seq` int unsigned NOT NULL COMMENT '적립 마일리지 시퀀스',
  `account_code` char(5) NOT NULL COMMENT '장부코드\n',
  `trade_code` varchar(20) NOT NULL COMMENT '거래번호',
  `trade_type` char(1) NOT NULL COMMENT '예매 = y, 예매취소 = n, , 충전 = c, 출금 = w',
  `before_mile` int unsigned NOT NULL DEFAULT '0' COMMENT '이전 마일리지',
  ...
  PRIMARY KEY (`seq`),
  KEY `fk_accum_mile_log_accum_mile1_idx` (`accum_mile_seq`),
  CONSTRAINT `fk_accum_mile_log_accum_mile1` FOREIGN KEY (`accum_mile_seq`) REFERENCES `accum_mile` (`seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='적립 로그';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='로그인 리스트';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `login_list` VALUES (1,1,'t','2022-12-06 21:31:59');
...
CREATE TABLE `mile_charge_list` (
  ...
  PRIMARY KEY (`seq`),
  KEY `fk_mile_charge_list_user_mileage1_idx` (`user_mileage_seq`),
  CONSTRAINT `fk_mile_charge_list_user_mileage1` FOREIGN KEY (`user_mileage_seq`) REFERENCES `user_mileage` (`seq`)
...
CREATE TABLE `mile_withdraw_list` (
  `seq` int unsigned NOT NULL AUTO_INCREMENT COMMENT '시퀀스',
  `user_mileage_seq` int unsigned NOT NULL COMMENT '회원 마일리지 시퀀스',
  `account_code` char(5) NOT NULL COMMENT '장부코드',
  `trade_code` varchar(20) NOT NULL COMMENT '거래번호',
  ...
  PRIMARY KEY (`seq`),
  KEY `fk_mile_withdraw_list_user_mileage1_idx` (`user_mileage_seq`),
  CONSTRAINT `fk_mile_withdraw_list_user_mileage1` FOREIGN KEY (`user_mileage_seq`) REFERENCES `user_mileage` (`seq`)
...
INSERT INTO `user_info` VALUES (1,'이현민','item1','123',1012345678,'item1@item.com','1998-02-09','농협',15641563,'0000-00-00 00:00:00','2022-12-06 21:31:37','n'),(2,'김현우','item2','123',104545,'item2@item.com','1992-03-08','농협',846854153,'0000-00-00 00:00:00','2022-12-06 21:31:56','n');
...
CREATE TABLE `user_mile_change_list` (
  ...
  PRIMARY KEY (`seq`),
  KEY `fk_user_mile_change_list_user_mileage1_idx` (`user_mileage_seq`),
  CONSTRAINT `fk_user_mile_change_list_user_mileage1` FOREIGN KEY (`user_mileage_seq`) REFERENCES `user_mileage` (`seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='마일리지 변동내역';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_mileage` (
  ...
  PRIMARY KEY (`seq`),
  KEY `fk_user_mileage_user_info1_idx` (`user_num`),
  CONSTRAINT `fk_user_mileage_user_info1` FOREIGN KEY (`user_num`) REFERENCES `user_info` (`user_num`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='사용자 마일리지';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_mileage` VALUES (1,1,'vc','item1',100,'2022-12-06 21:31:37'),(2,2,'vc','item2',100,'2022-12-06 21:31:56');
...
-- Dump completed on 2022-12-06 21:39:37
