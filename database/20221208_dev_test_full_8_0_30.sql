...
CREATE TABLE `accum_mile` (
  ...
  PRIMARY KEY (`seq`)
) ENGINE=InnoDB AUTO_INCREMENT=109 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='적립 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `accum_mile` VALUES (102,1,'ca01t',4500,0,'2022-12-08 21:29:15','2022-12-08 21:30:52'),(103,1,'ca02t',6300,6300,'2022-12-08 21:29:20','0000-00-00 00:00:00'),(104,1,'ca01t',1800,0,'2022-12-08 21:29:24','2022-12-08 21:34:00'),(105,1,'ca03t',8100,8100,'2022-12-08 21:29:30','0000-00-00 00:00:00'),(106,1,'ca01t',2700,1800,'2022-12-08 21:30:52','2022-12-08 21:53:33'),(107,1,'ca01t',900,900,'2022-12-08 21:32:17','0000-00-00 00:00:00'),(108,1,'ca01t',1800,1800,'2022-12-08 21:34:00','0000-00-00 00:00:00');
...
CREATE TABLE `accum_mile_log` (
  ...
  PRIMARY KEY (`seq`)
) ENGINE=InnoDB AUTO_INCREMENT=97 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='적립 로그';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `accum_mile_log` VALUES (89,102,1,'ca01t','20221208ca01t1',4500,'c','2022-12-08 21:29:15'),(90,103,1,'ca02t','20221208ca02t1',6300,'c','2022-12-08 21:29:20'),(91,104,1,'ca01t','20221208ca01t1',2700,'c','2022-12-08 21:29:24'),(92,105,1,'ca03t','20221208ca03t1',8100,'c','2022-12-08 21:29:30'),(93,102,1,'ca01t','20221208ca01t1',4500,'c','2022-12-08 21:30:52'),(94,104,1,'ca01t','20221208ca01t1',900,'c','2022-12-08 21:32:17'),(95,104,1,'ca01t','20221208ca01t1',1800,'c','2022-12-08 21:34:00'),(96,106,1,'ca01t','20221208ca01t1',2700,'c','2022-12-08 21:53:33');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='로그인 리스트';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_info` VALUES (1,'이현민','item1','123',11,'item1@item.com','1568-05-06','농협',485641,'0000-00-00 00:00:00','2022-12-08 16:27:59','n');
...
CREATE TABLE `user_mile_change_list` (
  ...
  PRIMARY KEY (`seq`)
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='마일리지 변동내역';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_mileage` VALUES (1,'ca01t',5400,'2022-12-08 21:53:33'),(1,'ca02t',0,'2022-12-08 21:53:33'),(1,'ca03t',6300,'2022-12-08 21:34:00');
...
-- Dump completed on 2022-12-08 22:46:16
